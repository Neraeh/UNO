...
Cards::Cards(UNO *_parent)
{
    ...
    cards.append(new Card("G", "+2"));
    cards.append(new Card("G", "+2"));
    cards.append(new Card("R", "R"));
    cards.append(new Card("R", "R"));
    cards.append(new Card("B", "R"));
    cards.append(new Card("B", "R"));
    cards.append(new Card("Y", "R"));
    cards.append(new Card("Y", "R"));
    cards.append(new Card("G", "R"));
    cards.append(new Card("G", "R"));
    cards.append(new Card("R", "S"));
    cards.append(new Card("R", "S"));
    cards.append(new Card("B", "S"));
    cards.append(new Card("B", "S"));
    cards.append(new Card("Y", "S"));
    cards.append(new Card("Y", "S"));
    cards.append(new Card("G", "S"));
    cards.append(new Card("G", "S"));
